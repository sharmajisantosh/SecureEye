...
import com.example.secureEye.Interface.UpdatePhoneResult;
...
public class UpdatePhoneNumber {
    ...
    private UpdatePhoneResult otp_verify_result;

    public UpdatePhoneNumber(Activity activity){
    ...
    public void sendOTP(String phoneNumber, final UpdatePhoneResult otp_verify_result){
